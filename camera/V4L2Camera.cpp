...
unsigned long V4L2Camera::saveYUYVtoJPEG (unsigned char *inputBuffer, int width, int height, unsigned char *& outbuffer, int quality)
{
    ...
    jpeg_mem_dest (&cinfo,&outbuffer,&fileSize);
